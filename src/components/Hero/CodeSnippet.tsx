...
function CodeSnippet({ darkMode }: CodeSnippetProps) {
  return (
    <div
      className={`w-full max-w-md p-1 rounded-2xl animate-bounce ${
        darkMode
      ...
      >
        ...
        >
          ...
          <div className="pl-4 mb-1">
            ...
            <span className="text-yellow-500">'Boluwatife Akingbade'</span>,
          </div>
          <div className="pl-4 mb-1">
          ...
          <div className="pl-4 mb-1">
            <span className="text-purple-500">isAvailable</span>:{" "}
            <span className="text-blue-500">true</span>,
          </div>
          <div className="pl-4 mb-1">
            <span className="text-purple-500">contact</span>:{" "}
            <span className="text-yellow-500">'email@boluwatife.tech'</span>
          </div>
          <div>{"}"}</div>
        </div>
      </div>
